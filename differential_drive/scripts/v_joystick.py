...
"background-color:#A52A2A;")  #A52A2A
        ...
        #FOURTH ROW SLAM COMMAND LAYOUT
        ...
        self.label_11.setMinimumSize(QtCore.QSize(300, 25))
...
"background-color:#A52A2A;")  #A52A2A
        ...
        # Add push buttons in the same row below label_11        
        self.btn_clrmap = QtWidgets.QPushButton(self.centralwidget)
        self.btn_clrmap.setObjectName("clear_map")
        self.btn_clrmap.clicked.connect(self.clear_map)
        self.gridLayout_11.addWidget(self.btn_clrmap, 2, 0, 1, 1)
        
        self.btn_enmap = QtWidgets.QPushButton(self.centralwidget)
        self.btn_enmap.setObjectName("enable_map")
        self.btn_enmap.clicked.connect(self.enable_map)  # You can connect it to a different slot if needed
        self.gridLayout_11.addWidget(self.btn_enmap, 2, 1, 1, 1)        
        
        self.btn_dismap = QtWidgets.QPushButton(self.centralwidget)
        self.btn_dismap.setObjectName("disable_map")
        self.btn_dismap.clicked.connect(self.disable_map)
        self.gridLayout_11.addWidget(self.btn_dismap, 3, 0, 1, 1)
...
"background-color:#A52A2A;color:white;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate("MainWindow", "COMMAND FOR SLAM"))
        self.btn_clrmap.setText(_translate("MainWindow", "CLEAR MAP"))
        self.btn_enmap.setText(_translate("MainWindow", "ENABLE MAP"))
        self.btn_dismap.setText(_translate("MainWindow", "DISABLE MAP"))       
    ...
    def clear_map(self):
    	print("CLEAR MAP")
    	self.pub.publish(16)
    	self.logs.setText(self.logs.toPlainText()+"CLEAR MAP\n")
    	x = self.logs.verticalScrollBar()
    	x.setValue(x.maximum())
    ...
    def enable_map(self):
    	print("ENABLE MAP")
    	self.pub.publish(17)
    	self.logs.setText(self.logs.toPlainText()+"ENABLE MAP\n")
    	x = self.logs.verticalScrollBar()
    	x.setValue(x.maximum())
    ...
    def disable_map(self):
    	print("DISABLE MAP")
    	self.pub.publish(18)
    	self.logs.setText(self.logs.toPlainText()+"DISABLE MAP\n")
    	x = self.logs.verticalScrollBar()
    	x.setValue(x.maximum())
